        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="card">
                            <form class="form-horizontal" method="POST" action="{{route('New_book_add.store')}}"  enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <h4 class="card-title">Create New Book Header Option</h4>
                                    <div class="form-group" >
                                        <label for="current_password" >Title*</label>
                                        <input id="current_password" name="title" type="text" class="required form-control" placeholder="Book Name Here">
                                    ...
                                    <div  style="height: 100px;" class="mb-5">
                                        <textarea id="editor" name="description"  class="required form-control" placeholder="Book Description Here"></textarea>
