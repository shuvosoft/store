        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="card">
                            <form class="form-horizontal" method="POST" action="{{route('New_book_footer.store')}}"  enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <h4 class="card-title">Create Book Footer Option</h4>
                                    <div class="form-group" >
                                        <label for="current_password" >Logo*</label>
                                        <input id="current_password" name="image" type="file" class="required form-control" >
                                    ...
                                    <div  style="height: 100px;" class="mb-5">
                                        <textarea id="editor" name="title"  class="required form-control" placeholder="Book Description Here"></textarea>
