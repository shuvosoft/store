                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{route('New_book_footer.create')}}"> <button class="btn btn-danger mt-5 mb-5">Create Footer Book Options </button></a>
                            ...
                            <div class="table-responsive">
                                <table id="zero_config" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    @foreach($bookFooters as $key=>$book)
                                        <tr>
                                            <td>{{$key + 1}}</td>
                                            <td>{{$book->title}}</td>
                                            <td>
                                                <img src="{{ Storage::disk('public')->url('footerLogo/'.$book->image) }}">
                                            </td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form id="delete-form-{{$book->id }}" action="{{ route('New_book_footer.destroy',$book->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
