            ...
            <div class="row">
                <div class="col-12">
                    <div class="menu mt-4 mb-4">
                        <a href="{{route('book.create')}}"><button class="btn btn-danger">Add Book</button></a>
                            ...
                            <div class="table-responsive">
                                <table id="zero_config" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$book->price}}</td>
                                        <td>
                                            <img src="{{ Storage::disk('public')->url('book/'.$book->image) }}" class="img-responsive" alt="{{ $book->title }} " width="80px" height="50px" >
                                        </td>
