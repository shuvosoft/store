                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{route('order.create')}}"> <button class="btn btn-danger mt-5 mb-5">Add Order Details</button></a>
                                ...
                                <table id="zero_config" class="table table-striped table-bordered">
                                    ...
                                    @foreach($orders as $key=>$order)
                                        <tr>
                                            ...
                                            <td>{{str_limit($order->order_des, '25')}}</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-danger waves-effect" type="button" onclick="deleteCategory({{$order->id }})">
