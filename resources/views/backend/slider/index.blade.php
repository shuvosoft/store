                ...
                <div class="table-responsive">
                    <table id="zero_config" class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{!! str_limit($slider->title, '20') !!}</td>
                            <td><img src="{{ Storage::disk('public')->url('slider/'.$slider->image) }}" style="width: 80px; height: 50px"></td>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn btn-danger waves-effect" type="button" onclick="deleteCategory({{$slider->id }})">
