                            ...
                            <form class="form-horizontal" method="POST" action="{{route('slider.update',$slider->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    {{--<div class="slider-title">--}}
                                        ...
                                        {{--<div class="col-sm-12 ">--}}
                                            ...
                                            {{--<div  style="height: 100px;" class="mb-5">--}}
                                                {{--<textarea  name="title"  class="required form-control" placeholder="Slider Title Here">{{$slider->title}}</textarea>--}}
                                    ...
                                    {{--<div class="form-group row">--}}
                                        ...
                                        {{--<div class="col-sm-9">--}}
                                            {{--<input type="text" name="button_text" value="{{$slider->button_text}}" class="form-control" id="fname" placeholder="Slider Button Text Here">--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                                    ...
                                    {{--<div class="form-group row">--}}
                                        ...
                                        {{--<div class="col-sm-9">--}}
                                            {{--<input type="url" name="button_link" value="{{$slider->button_link}}" class="form-control" id="fname" placeholder="Slider Button link Here">--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
